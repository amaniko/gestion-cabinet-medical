...
<div class="container">
   <div class="row justify-content-center">
                 ...
                 <a name="1">
                  <form method="POST" action="{{url('Certif/store')}}">
                    ...
                    <h3 class="titre">Certificat Médical</h3>
                     <div class="row"> <p> Je soussigné, Docteur Zribi,certifie que létat de santé de M/Mme/Mlle</p>
    ...
    <a name="3">
      ...
      <form method="POST" action="{{url('Certif/store')}}">
        @csrf
      <div class="row"> <p> Je soussigné, Docteur Zribi,certifie que M/Mme/Mlle</p>
        <div class="form-group">
        <input type="text" name="nompatient" >
        </div>
       <p> s'est présenté à ma consultation le </p>
       <input type="date" name="date" id="date"><p>à </p>
       <input type="text" maxlength="4" size="1px" name="nbjour" id="nbjour">
      </div>
           <div style="right: 10000050em" class="container">
                      <p> Date  :</p>
