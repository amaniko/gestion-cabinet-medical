...
Route::get('/ord',[App\Http\Controllers\ordController::class,'editord'])->name('editord.print');
Route::post('/ord',[App\Http\Controllers\ordController::class,'editord'])->name('editord');
